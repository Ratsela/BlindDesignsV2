...
startScreen_js = function(runBeforeShow) {
    ...
    var n2id_buf = {
        'mobilelist_39': 'startScreen_mobilelist_39',
        'mobilelistitem_40': 'startScreen_mobilelistitem_40',
        'mobilelistitembutton_41': 'startScreen_mobilelistitembutton_41',
        'mobilelistitem_42': 'startScreen_mobilelistitem_42',
        'mobilelistitembutton_43': 'startScreen_mobilelistitembutton_43',
        'mobilelistitem_44': 'startScreen_mobilelistitem_44',
        'mobilelistitembutton_45': 'startScreen_mobilelistitembutton_45',
        'mobilelistitem_46': 'startScreen_mobilelistitem_46',
        'mobilelistitembutton_47': 'startScreen_mobilelistitembutton_47',
        'mobilelistitem_48': 'startScreen_mobilelistitem_48',
    ...
    var startScreen_elementsExtraJS = function() {
            ...
            listView = $("#startScreen_mobilelist_39");
            theme = listView.attr("data-theme");
            if (typeof theme !== 'undefined') {
                var themeClass = "ui-btn-up-" + theme;
                listItem = $("#startScreen_mobilelist_39 .ui-li-static");
    ...
    var startScreen_elementsEvents = function() {
            ...
            $(document).off("click", '#startScreen_mobilecontainer1 [name="mobilelistitem_40"]').on({
                click: function() {
                    if (!$(this).attr('disabled')) {
                        Apperyio.navigateTo('Visualizer', {
                            reverse: false
                        });

                    }
                },
            }, '#startScreen_mobilecontainer1 [name="mobilelistitem_40"]');
